...
First, it reuses their data requiring them to implement a minimal \ac{rest}-like \ac{api}.
Second, it enables these third party web applications to reuse the data written in the space by means of an analogous \ac{api}. % analogous, equivalent, similar
...
To avoid that, i.e. to promote the reuse of third \ac{wot} applications' actuation capacities, we suggest how to integrate a proof-based mechanism with the regular \ac{tsc} usage.
