...
Secondly, it enables these third party web applications to reuse the data written in the space by means of an analogous \ac{api}. % analogous, equivalent, similar
