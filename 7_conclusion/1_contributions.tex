...
\begin{itemize}
  ...
  \item Chapter~\ref{cha:tsc} depicts a two-space model which (1) preserves \ac{tsc}'s decoupling properties and (2) respects \ac{ubicomp}'s distributed nature.
    ...
    \begin{itemize}
      ...
      \item It describes the model. % compromise between
...
\begin{itemize}
  \item Analyze the security aspects which need to be addressed in this environments and present a solution. % que puede ser adaptada a esto
