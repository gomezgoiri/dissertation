...
\begin{itemize}
  \item Chapter~\ref{cha:stateoftheart} presents an in-depth state-of-the-art review.
    \begin{itemize}
      ...
      \item It portrays this dissertation regarding the relevant works from related research fields.
	    ...
	    The analysis shows how existing works do not address the problems tacked by this dissertation.
    \end{itemize}
  ...
  \item Chapter~\ref{cha:tsc} depicts a two-space model which
    ...
    \begin{itemize}
      ...
      \item It designs the middleware by presenting the adopted primitives and how the spaces can be accessed through an \ac{http} \ac{api}.
