...
Both spaces are accessed through a resource-oriented \ac{http} \ac{api} to ease reusing contents by third \ac{rest}-like applications. % TODO se entiende REST-like?? habrá que explicarlo
...
\input{\pathchapsix/1_contributions}
\input{\pathchapsix/2_publications} % o si queda muy corto, incluirlo directamente en conclusions
\input{\pathchapsix/3_futurework}
\input{\pathchapsix/4_finalremarks}
