\InsertTab{tab:measuresEmbedded}{Response times for web servers running in different devices and providing semantic content}{
Each provider replies from 1 to 15 concurrent requests.
The response times' means and the standard deviations (in parenthesis) are measured in milliseconds.
}{
