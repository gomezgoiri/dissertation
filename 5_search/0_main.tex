...
Finally, Section~\ref{sec:search_discussion} states the conclusions of our work.


%------------------------------------------------------------------------- 

% comprobar y aplicar los ultimos cambios y ajustes introducidos en el svn de IJWGS!
\input{\pathchapfive/1_intro}
\input{\pathchapfive/2_relatedwork}
\input{\pathchapfive/3_proposal}
\input{\pathchapfive/4_environment}
\input{\pathchapfive/5_evaluation}
\input{\pathchapfive/6_discussion}
