...
\InsertFig{clues_recall}{fig:recall_measures}{\emph{Recall} for each type of clue}{}{1}{}

\InsertFig{clues_precision}{fig:precision_measures}{\emph{Precision} for each type of clue}{}{1}{}
...
\InsertFig{clues_length}{fig:clueSize}{Length for types of clues}{}{0.6}{}
...
\InsertFig{requests_by_strategies}{fig:requestsByStrategies}{Required requests for different search strategies}{
...
\InsertFig{requests_by_roles}{fig:requestsByRoles}{Requests between roles in our solution}{
The \Space{} evaluated has 100 \consumers{} and from 105 to 295 nodes in total (including the \consumers{}).
``\emph{Prov-WP}'' denotes the communication between \providers{} and the \acs{wp},
``\emph{Cons-WP}'' the communication between \consumers{} and the \acs{wp},
and ``\emph{Cons-Prov}'' \consumers{}' requests to \providers{}.
}{0.8}{}
