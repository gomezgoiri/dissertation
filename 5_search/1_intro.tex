...
We propose a solution where intermediaries are used to release some workload from the less powerful devices, but at the same time, the direct communication between the devices is promoted.
In particular, our system uses intermediaries to search where the data is located in it and then queries the final devices directly. % esta frase es engañosa y da a entender algo que no es así!
...
% la explicación de la estructura del capítulo ya ha sido dada en "0_main"