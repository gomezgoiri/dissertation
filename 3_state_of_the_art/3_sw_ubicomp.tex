...
% TODO TODO TODO poner este footnote sólo dónde nos hayamos referido a Android por primera vez
...
Some solutions embed the metadata in HTML using microdata\footnote{\url{http://www.w3.org/TR/microdata/}}, microformats\footnote{\url{http://microformats.org}} or RDFa\footnote{\url{http://www.w3.org/TR/rdfa-primer/}}.
...
A more general way to represent semantic data is using RDF\footnote{\url{http://www.w3.org/RDF/}} based representations (i.e., full semantics). % más general que los microformatos que usan Guinard y compañía
