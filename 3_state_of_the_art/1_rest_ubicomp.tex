...
\InsertFig{venn-sec1_1}{fig:venn_ubicomp}{Non-semantic works for \ac{ubicomp} apart from \aclp{ts}}{
This subsection focuses on the solutions using \ac{rest} architectures.
}{0.6}{}
