...
In fact, the magnitude of the sensors where data are generated can be enormous. % are => data es plural
...
This strategy is not only useful to ensure the access to updated data, but also for the following causes: % beneficios o razones?
