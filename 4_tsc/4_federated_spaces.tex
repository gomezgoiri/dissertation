...
\input{\pathchapfour/tables/http_api_extension}
...
\begin{description}
 ...
 \item[Reading.]
      ...
      Finally, the \emph{read} primitive's results will be enriched with \selfgraphs{} from the \outerspace{}. % mediante redirect o lo que sea
\end{description}