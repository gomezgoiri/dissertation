...
In this section, we present our materialization of \ac{tsc} \acs{api} over \ac{http}.
...
Note that this thesis does not consider using more sophisticated query languages like SPARQL \footnote{\url{http://www.w3.org/TR/rdf-sparql-query/}}. % sophisticated o expressive?
The rationale behind this decision is that we wanted to avoid the complexity introduced by these languages in our \ac{api}.
While the advanced query languages need to be interpreted with parsers not available in many embedded platforms,
...
The \acs{api} should be compliant with the standardized \acs{http} status codes \footnote{\url{http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html}}.
