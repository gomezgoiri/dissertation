...
\InsertFig{tsc_resources}{fig:tsc_resources}{Representation of a space and the elements it is composed of}{
The figure shows a space with four graphs and sample triples for one of these graphs.
Note that the figure uses prefixes, i.e., aliases for the beginning of the \acp{uri}, for the sake of clarity.
}{1}{}
