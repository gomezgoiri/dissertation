...
This vision can benefit from the \acf{tsc} paradigm's decoupling properties. % mencionarlas? citar a alguien que diga que TSC puede molar para eso?
...
\input{\pathchapfour/1_guiding_principles}
\input{\pathchapfour/2_hybrid_solution} % o halfway solution?
\input{\pathchapfour/3_http_alignment}
\input{\pathchapfour/4_federated_spaces}
\input{\pathchapfour/5_evaluation}
\input{\pathchapfour/6_summary}