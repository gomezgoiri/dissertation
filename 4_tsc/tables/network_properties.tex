\InsertTab{tab:network_properties}{Properties of different architectural styles for network-based applications as defined by \citet{fielding_architectural_2000}}{
  ...
  The leftest column contains each of the network substyles \acs{rest} derives from:
  \acf{restcs}, \acf{rests}, \acf{restcache}, \acf{restu}, \acf{restl} and \acf{restcod}.
  
  The horizontal line indicates that the inmediate row below is composed by all the rows from the upper level.
