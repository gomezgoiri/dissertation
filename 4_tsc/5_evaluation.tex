...
This components share an even bigger amount of data which leads to scalability challenges on the search process \citep{krummenacher_scalability_2008}. % porque tienes que preprocesar todo el contenido a buscar
