...
\begin{description}
  \item[Performance] is divided into network performance, user-perceived performance and efficiency.
    \begin{description}
      ...
      \item[User-perceived performance] refers to the impact perceived by a user in front of an application. % UP Performance es una feature que no aporta mucho a nuestro caso
