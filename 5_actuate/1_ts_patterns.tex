...
% un esquema en el que aparecen todos los patrones explicados
...
% A pesar de que X e Y, han usado el patrón tal y cual en TSC, nosotros creemos que el más util para Ubicomp es X e Y.
