...
% TODO Definir palabras rollo Tuple Spaces para ser uniforme a lo largo del texto y no llamarle tspaces, tuplespaces, o tuple spaces
...
%: ----------------------- introduction ------------------------
\include{1_introduction/0_main}

%: ----------------------- related work ------------------------
% 20 al 22 de Feb % estado del arte sin tablas ni figuras y a falta de hacerlo más detallado
% pero tener todo en conjunto
\include{2_state_of_the_art/0_main}

% del 25 al 1 ir pegando cachos de papers en las secciones para ver cómo quedaría y qué más haría falta

%: ----------------------- TSC for resource constrained devices ------------------------
\include{3_tsc/0_main}

%: ----------------------- On how to Search in TSC ------------------------
\include{4_search/0_main}

%: ----------------------- On how to actuate through TSC ------------------------
\include{5_actuate/0_main}

%: ----------------------- Otsopack: implementation ------------------------
\include{6_implementation/0_main}

%: ----------------------- conclusion ------------------------
\include{7_conclusion/0_main}	
