...
We have conducted a simulation to evaluate the benefits of our solution against a flooding-based approach (i.e., \ac{nb}).
In addition, to give a more exhaustive comparison, we have implemented and tested query caching on top of \ac{nb}.
...
To that end, we simulate the behavior of the \ac{mdns} and \ac{dns-sd}\footnote{\url{http://tools.ietf.org/html/rfc6763}} protocols.
Both protocols are based on the well known and widely accepted \ac{dns}.

On the one hand, \ac{dns-sd} proposes the use of the data field of TXT records to share key/values.
