...
\subsubsection{Restricted Energy and Computation}

% TODO dividirlo en 2 distintos??
...
% The verboseness of semantic data affects both aspects: computing and networking.
In that regard, a inference process must be too heavyweight. % autocita?
% por eso, el mecanismo de búsqueda se hace en los cacharros más potentes
% por eso no lo imponemos como un requisito ni para los consumidores ni para los proveedores, aunque sea recomendable.
