...
Section~\ref{sec:hybrid_solution} proposes a mix model which encompases
(a) an independent space which can be used by the devices for coordination purposes, and
