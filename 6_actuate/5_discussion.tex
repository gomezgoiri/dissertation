...
Specifically, we analyse how to transparently invoke \ac{rest}-like services on behalf of the developer using the \Space{}. % or "the space-based patterns presented in the previous section."
