...
% IG: \ref{sec:actuation_interoperation} se tendria que presentar antes.

The rest of this chaper is organized as follows.
...
Section~\ref{sec:actuation_interoperation} explores this reuse through a practical example. % IG: reuse?
...
% IG: es una tercera tecnica? Pues esto deberia presentarse junto a las otras dos...
% IG: creo que esto del escenario se tendria que poner a parte de esta tercera movida
