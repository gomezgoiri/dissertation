...
\begin{table}[htbp]
  ...
  \begin{center}
    ...
    \begin{tabular}{lccc}
      ...
      \ac{rest} \acp{api} & Direct & Reuse of third \ac{wot} & Rule-based \\ % mencionar interop? % TODO ampliar la noción de WoT a REST-like?
      consumption & & applications & reasoning \\ % no digo "wot actuation capacities porque ya está verbalizado en la explicación"
      \hline
    \end{tabular}
  \end{center}
