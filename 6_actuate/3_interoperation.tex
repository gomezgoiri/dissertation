...
\begin{enumerate}[label=\itshape(\alph*\upshape)]
  ...
  \item It is aware of the tasks written into the space and changes the light's value accordingly (see Figure~\ref{fig:flow_type_b}). % esto es, se suscribe a ellas
\end{enumerate}
