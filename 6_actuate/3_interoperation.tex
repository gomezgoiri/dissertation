...
\begin{figure}
	...
	\subfigure[\typed] {
        ...
        {Please note that \typea{} is omitted because its operation is the usual for a \acs{http} server.} % actions, behavior, operation???
...
So, starting from \emph{/lamp}, based on the dereferenceable \acsp{uri} \citep{sauermann_cool_2008} and the descriptions, a crawler can autonomously learn how to use the \acs{api}. % TODO citar http://en.wikipedia.org/wiki/Dereferenceable_Uniform_Resource_Identifier
