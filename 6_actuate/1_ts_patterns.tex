...
% IG: comentario sobre el comentario, q me ensenyaste tu: closer to optimal, no more optimal.
% IG: encourage no creo que sea la palabra...

As a consequence, a notification mechanism is highly advisable to fulfil \ac{ts}'s patterns in a distributed environment.
...
% The requirements that this mechanism needs to fulfil are the following ones:
% \begin{itemize}
