...
In contrast, \ac{rest}-like services constitute an emerging mechanism to directly actuate in the physical environment. % REST-like, no compliant with Fielding
...
% TODO TODO TODO esto ya no es así!!!
