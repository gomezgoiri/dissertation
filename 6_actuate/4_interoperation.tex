...
% TODO IG bien, ahora tengo una idea mas clara... Creo que deberias hacer lo de los nombrecitos y llamar a esta "Hybrid actuation". Entonces juntamos el 6.3 y el 6.4 bajo el titulo de hibrido. Entonces dices, las dos anteriores tienen problemas los rpesentas con la comparacion, y venga.
% TODO IG otro cambio mas chungo, que te parece si quitas todos los base scenario: implementation de donde estan y creas una seccion de implementacion con cada seccion. Algo del palo:
% 6.1 Space-based actuation
% 6.2 Direct actuation
% 6.3 Hybrid actuation
% 6.4 Base scenario: implementation (o titulo similar)
% Creo que aqui deberias meter todo lo de los escenarios del envisaged o lo que sea
% 6.4.1 Space-based actuation
% 6.4.2 Direct actuation
% 6.4.3 Hybrid actuation
% Entonces creo que toda la 6.5 se puede reducir y metarla en las secciones anteriores
