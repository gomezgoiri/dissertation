...
Section~\ref{sec:actuation_comparison} compares the techniques presented in the previous and argues their integration.
...
To this end, it reuses the nodes from the implementations presented in sections \ref{sec:actuation_scn1} and \ref{sec:actuation_scn2}.
...
As a consequence of these few requirements, exposing the actuation capacities of the limited devices making them part of the web is an upcoming tendency.
...
For that, the simplicity of the space-based consumer should be respected. % Simplicidad: networking y computing que aparecen en la tabla.
