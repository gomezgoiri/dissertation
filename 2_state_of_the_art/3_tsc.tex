...
\citet{nardini_semantic_2013} extends TuCSoN \cite{omicini_tucson:_1998}.
TuCSoN also follows a flat model where different independent tuple centres can coexist at the same time. % o created?
However, it presents an evolution of the \ac{ts} called \emph{tuple centre}.
...
Finally, CSpaces \citep{martinrecuerda_towards_2005} proposes the more original space model.
...
%    https://code.google.com/p/tucson/source/browse/TuCSoN/trunk/src/alice/tucson/examples/helloWorld/HelloWorld.java
