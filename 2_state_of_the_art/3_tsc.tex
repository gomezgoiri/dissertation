...
% TODO TODO TODO explicar el modelo de vista de info y vista de knowledge!
...
% Model: Triple Space
The use of standard semantic protocols and \ac{rdf} triple-like turtles characterizes \acl{tsc}. % restringido a subconjunto de los trabajos analizados
% Originalmente TSC estaba basado en REST
\ac{tsc} was born to realign web services (WS-*) with the web.
To ensure this alignment, it was based on \ac{rest} architectural style's principles \citep{fensel_triple-space_2004}.
...
Table~\ref{tab:rest_principles} shows the conflicts that the analyzed works present with these principles.
...
\input{2_state_of_the_art/tables/rest_principles}
