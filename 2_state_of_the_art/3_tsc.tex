...
% modelo propuesto
Nardini et al. \cite{TODO} explores the use of Description Logics on top of an existing \emph{tuple centre} implementation called TuCSoN. % TODO CITA
...
CSpaces and Nardini et al. propose the use of a language-independent first-order logic (FOL).
However, since most advanced reasoners only implement a subset of FOL, any implementation is limited by them. % también estas
...
Centralized Tuple Spaces are much simpler and easier to implement.
...
Within the distributed Tuple Spaces, a wide range of distribution strategies have been detected.
...
%In this thesis, we aim to implement a completely distributed Semantic Tuple Space.
...
So far, semantic Tuple Spaces solutions have offered a sophisticated models with interesting additional features.
