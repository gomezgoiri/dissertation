...
% modelo propuesto
Tsc++ \cite{krummenacher_open_2009} is a new version of the TSC project build on top of the \emph{Jxta} P2P framework \footnote{https://jxta.dev.java.net/}. % cita?


% cosas relativas al despliegue
Instead of replicating each space in the different kernels as TSC does, tsc++ proposes to store each content locally.
Therefore, to query over the data, the queries are spread to the rest of the nodes in the space.
