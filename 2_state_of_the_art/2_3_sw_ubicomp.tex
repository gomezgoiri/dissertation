\subsection{\acl{sw} for \acl{ubicomp}}
...
\subsubsection{\acl{sw} in Providers}
...
Generally, these solutions embed the metadata in \acs{html} using microdata, microformats or RDFa \citep{mayer_extensible_2011}. % TODO mirar tesis de Guinard 2.2.1 y posiblemente citar!!!
