...
\InsertFig{triples_example}{fig:triples_example}{
  ...
  The knowledge is expressed using four different ontologies: FOAF\footnote{\url{http://www.foaf-project.org/}}, DC\footnote{\url{http://dublincore.org/}}, SWRC\footnote{\url{http://ontoware.org/swrc/}} and CiTO\footnote{\url{http://purl.org/spar/cito}}.
