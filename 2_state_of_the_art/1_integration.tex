...
Coulouris et al. \cite{coulouris_distributed_2012} define two communication styles on the upper layer of a middleware: % figura 4.1 modificada para incluir elementos
...
and the \ac{wot} \cite{guinard_internet_2011}. % Mejor poner su tesis?


\InsertFig{venn-sec1_1}{fig:venn_ubicomp}{
  Integration approaches for Ubicomp apart from \aclp{ts}.
}{
...
% \ac{wot} necesita de Web Semántica, se analizará más tarde
